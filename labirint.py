...
back = (134,138,204)
w1 = GameSprite('lol.jpg', win_width / 2 - win_width /3, win_height /2, 300, 500)
w2 = GameSprite('lol.jpg', 370,100,50,400)
hero = Player('ag.png', 5, win_height - 80,80,80,0,0)
enemy = Enemy('svin.png',5, win_height - 80,80,80,0)
...
while ruun:
    ...
    for i in event.get():
        if i.type == QUIT:
            ruun = False
    wall_12 = GameSprite('lol.jpg', 80,180,200,250)
